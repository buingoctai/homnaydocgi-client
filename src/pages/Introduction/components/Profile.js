...
import { authorBrielf, skillGroup, skillDescribe } from '../../../utils/constants';
  ...
  return (
    ...
    >
      <div className={classes.imageContainer}>
        <a href="https://www.facebook.com/bui.ngoctai.71" target="_blank" rel="noopener noreferrer">
          <Avatar
      ...
      <div className={classes.brielfAuthor}>
        <List>
          <ListItem>
            ...
            <ListItemText primary={name.toUpperCase()} secondary={authorBrielf.name} />
          </ListItem>
          ...
          <ListItem>
            ...
            <ListItemText primary={phone.toUpperCase()} secondary={authorBrielf.phone} />
          </ListItem>
          <Divider variant="inset" component="li" />
        </List>
      </div>
      <div className={classes.skillInform}>
        <Tooltip title={skillDescribe.programmer} placement="top">
          <Chip label={skillGroup.programmer} color="primary" style={{ marginLeft: '10px' }} />
        </Tooltip>
        ...
        <Tooltip title={skillDescribe.sharer} placement="top">
          <Chip label={skillGroup.sharer} color="primary" style={{ marginRight: '10px' }} />
        </Tooltip>
        ...
        <Chip
          ...
          onClick={() =>
            (document.location.href = 'https://www.linkedin.com/in/t%C3%A0i-b%C3%B9i-0010a6152/')
          }
        />
      </div>
    </div>
